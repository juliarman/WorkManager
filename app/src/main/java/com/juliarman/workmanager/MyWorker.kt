...
class MyWorker(context: Context, workerParams: WorkerParameters): Worker(context, workerParams) {
    ...
    companion object{
        ...
        const val APP_KEY = "46b29219e2128a38c39b6e7591b302d1"
    ...
    private fun getCurrentWeather(dataCity: String?): Result {
        ...
        val url ="https://api.openweathermap.org/data/2.5/weather?q=$dataCity&appid=$APP_KEY"
        ...
        client.post(url, object : AsyncHttpResponseHandler() {
            override fun onSuccess(
                ...
                try {
                    ...
                    val tempInCelcius = tempKelvin - 273
            ...
            override fun onFailure(
                ...
                //Klw gagalki prosesnya, maka jobFinished di set dgn parameter true, yg artinya job perlu di reschedule
